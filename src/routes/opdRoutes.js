...
const {deleteOPDCamp, getAllPreviousOPDCamps, getNextFourOPDCamps, getMostUpcomingOPDCamp, addNextOPDCamps, getFourPreviousOPDCamps, getAllTodaysOPDCamps, getNextOPDCamps} = require("../controller/OpdController");
...
router.delete("/opdcamps/:id", deleteOPDCamp);
